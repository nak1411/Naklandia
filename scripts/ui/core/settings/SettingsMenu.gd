...
func _build_graphics_settings():
	...
	# VSync setting
	graphics_settings.append(
		{"id": "vsync_mode", "name": "V-Sync", "type": "dropdown", "options": graphics_manager.get_available_vsync_modes(), "default": graphics_manager.default_settings.get("vsync_mode", "Enabled")}
	)
	...
	graphics_settings.append(
		{"id": "render_scale", "name": "Render Scale", "type": "slider", "min": 0.25, "max": 2.0, "default": graphics_manager.default_settings.get("render_scale", 1.0), "format": "percentage"}
	)

	# Max FPS setting
	var fps_options = ["30", "60", "120", "144", "Unlimited"]
	graphics_settings.append({"id": "max_fps", "name": "Max FPS", "type": "dropdown", "options": fps_options, "default": graphics_manager.default_settings.get("max_fps", 0)})
...
func _build_audio_settings():
	...
	audio_settings.append(
		{"id": "master_volume", "name": "Master Volume", "type": "slider", "min": 0.0, "max": 1.0, "default": audio_manager.default_settings.get("master_volume", 0.8), "format": "percentage"}
	)

	audio_settings.append(
		{"id": "music_volume", "name": "Music Volume", "type": "slider", "min": 0.0, "max": 1.0, "default": audio_manager.default_settings.get("music_volume", 0.6), "format": "percentage"}
	)

	audio_settings.append(
		{"id": "sfx_volume", "name": "Sound Effects", "type": "slider", "min": 0.0, "max": 1.0, "default": audio_manager.default_settings.get("sfx_volume", 0.8), "format": "percentage"}
	)
...
func _build_gameplay_settings():
	...
	gameplay_settings.append({"id": "auto_save", "name": "Auto Save", "type": "checkbox", "default": gameplay_manager.default_settings.get("auto_save", true)})
...
func _create_checkmark_texture() -> ImageTexture:
	...
	var checkmark_pixels = [Vector2i(3, 8), Vector2i(4, 9), Vector2i(5, 10), Vector2i(6, 9), Vector2i(7, 8), Vector2i(8, 7), Vector2i(9, 6), Vector2i(10, 5), Vector2i(11, 4), Vector2i(12, 3)]
...
func get_setting_value(setting_id: String, default_value):
	...
	if audio_manager and setting_id in ["master_volume", "music_volume", "sfx_volume"]:
		return audio_manager.get_current_setting(setting_id, default_value)
	if gameplay_manager and setting_id in ["mouse_sensitivity", "auto_save"]:
