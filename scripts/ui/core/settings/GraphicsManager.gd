...
func _detect_available_resolutions():
	...
	var common_resolutions: Array[Vector2i] = [Vector2i(1280, 720), Vector2i(1366, 768), Vector2i(1600, 900), Vector2i(1920, 1080), Vector2i(2560, 1440), Vector2i(3840, 2160)]
...
func _apply_quality_settings(settings: Dictionary):
	...
	if settings.has("shadow_atlas_size"):
		RenderingServer.viewport_set_positional_shadow_atlas_size(viewport.get_viewport_rid(), settings["shadow_atlas_size"], true)
...
func _apply_directional_shadow_size(_size: int):
