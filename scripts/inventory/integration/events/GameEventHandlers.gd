...
func _trigger_drop_effects(item_data: Dictionary):
...
func _trigger_container_effects(container_id: String, action: String):
	"""Trigger container interaction effects"""
	var sound_name = "container_" + action
	_play_sound_at_position(sound_name, Vector3.ZERO)

func _trigger_item_move_effects(item_data: Dictionary):
...
func _spawn_pickup_particles(item_data: Dictionary):
