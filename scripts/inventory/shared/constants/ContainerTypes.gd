...
enum Type { NONE, GENERAL_CARGO, SECURE_CONTAINER, HANGAR_DIVISION, SHIP_CARGO, AMMUNITION_BAY, FUEL_BAY, PLAYER_INVENTORY, LOOT_CONTAINER, TRASH_CONTAINER }
...
static func get_type_name(type: Type) -> String:
	match type:
		...
		Type.SECURE_CONTAINER:
			return "Secure Container"
		Type.HANGAR_DIVISION:
			return "Hangar Division"
		Type.SHIP_CARGO:
			return "Ship Cargo"
		Type.AMMUNITION_BAY:
			return "Ammunition Bay"
		Type.FUEL_BAY:
			return "Fuel Bay"
