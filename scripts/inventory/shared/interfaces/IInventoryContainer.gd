...
func add_item(_item: InventoryItem_Base, _quantity: int = -1) -> bool:
	push_error("IInventoryContainer.add_item() not implemented")
	return false


func remove_item(_item: InventoryItem_Base, _quantity: int = -1) -> bool:
	push_error("IInventoryContainer.remove_item() not implemented")
	return false


func has_item(_item: InventoryItem_Base) -> bool:
	push_error("IInventoryContainer.has_item() not implemented")
	return false


func can_add_item(_item: InventoryItem_Base, _quantity: int = -1) -> bool:
