...
func _update_info_display():
	...
	info_text += "[color=yellow]F3/`:[/color] Toggle  [color=yellow]F4:[/color] Bounds  [color=yellow]F5:[/color] Info  [color=yellow]F8:[/color] Refresh  [color=yellow]F9:[/color] Reset Pos\n"
	info_text += "[color=yellow]F6:[/color] Visible Only (%s)  [color=yellow]F7:[/color] Focused Only (%s)\n\n" % [
		"ON" if show_only_visible else "OFF",
		"ON" if show_only_focused else "OFF"
	]
